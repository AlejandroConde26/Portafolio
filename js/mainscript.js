...
document.addEventListener('mousemove', function(e) {
    ...
    //calcular el movimiento para la imagen de fondo y el texto
    ...
    //aplicar un movimiento inverso al texto para dar un efecto de profundidad
    text.style.transform = `translate(-50%, -50%) translate(${moveX * 3}%, ${moveY * 3}%)`; 
  });
